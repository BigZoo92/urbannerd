...
import { checkIfPostIsLiked, getUrl, getUserInfoWithId, toggleLikePost } from '@/app/utils';
...
import { checkIfPostIsBookmarked, toggleBookmark } from '@/app/utils/post/fetchBookmark';
