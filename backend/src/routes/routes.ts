...
router.get("/getUserInfoWithId/:userId", (req, res) =>
  getUserInfoWithId(req, res)
);
...
//GET LIKE
router.get("/isPostLikedByUser/:postId", (req, res) =>
  isPostLikedByUser(req, res)
);
...
// GET LIKE COUNT
router.get("/post/:postId/likes/count", (req, res) =>
  getPostLikesCount(req, res)
);

// GET LIKED POST BY A USER
router.get("/user/:userId/likedPosts", (req, res) =>
  getUserLikedPosts(req, res)
);
